...
@section('multiple-action-button')
    @can('create-category')
        <div class="btn btn-sm btn-primary btn-icon m-1 float-end" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Create Category') }}">
            <a href="{{route('admin.category.create')}}" class=""><i class="ti ti-plus text-white"></i></a>
        </div>  
    @endcan

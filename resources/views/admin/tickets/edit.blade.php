...
<div class="row justify-content-end">
    <div class="col-auto">
        ...
        <div class="btn btn-sm btn-primary btn-icon m-1 float-end">
            <a href="#ticket-info" class="" type="button" data-bs-toggle="collapse" data-bs-placement="top" title="{{ __('Edit Ticket') }}"><i class="ti ti-edit text-white"></i></a>
        </div>
        @endcan
    </div>
</div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-select {{ !empty($errors->first('category')) ? 'is-invalid' : '' }}" name="category" required="">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-select {{ !empty($errors->first('status')) ? 'is-invalid' : '' }}" name="status" required="">
                ...
                <div class="text-end">
                    ...
                    <a class="btn btn-secondary btn-light mr-2" href="{{ route('admin.tickets.index') }}">{{ __('Cancel') }}</a>
                    ...
                    <div class="col">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">O.D.</th>
                                    <td>{{ $ticket->esfera_der }}</td>
                                    <td>{{ $ticket->cilindro_der }}</td>
                                    <td>{{ $ticket->eje_der }}</td>
                                    <td>{{ $ticket->adicion_der }}</td>
                                    <td>{{ $ticket->dnp_der }}</td>
                                    <td>{{ $ticket->altura_der }}</td>
                                </tr>
                                <tr>
                                    <th scope="row">O.I.</th>
                                    <td>{{ $ticket->esfera_izq }}</td>
                                    <td>{{ $ticket->cilindro_izq }}</td>
                                    <td>{{ $ticket->eje_izq }}</td>
                                    <td>{{ $ticket->adicion_izq }}</td>
                                    <td>{{ $ticket->dnp_izq }}</td>
                                    <td>{{ $ticket->altura_izq }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col text-center p-3">
                            ...
                            <table class="table table-bordered table-striped mt-2">
                                ...
                                <tbody>
                                    <tr> 
                                        <td>{{ $ticket->horizontal }}</td>
                                        <td>{{ $ticket->puente }}</td>
                                        <td>{{ $ticket->vertical }}</td>
                                        <td>{{ $ticket->diagonal }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="row mt-1">
                        <div class="col text-center">
                            <table class="table table-bordered table-striped mt-2">
                                ...
                                <tbody>
                                    <tr> 
                                        <td>{{ $ticket->tipo_lente }}</td>
                                        <td>{{ $ticket->biselado }}</td>
                                        <td>{{ $ticket->tipo_armazon }}</td>
                                        <td>{{ $ticket->material }}</td>
                                        <td>{{ $ticket->tratamiento }}</td>
                                        <td>{{ $ticket->tinte }}</td>
                                    </tr>
                                </tbody>
                            </table>

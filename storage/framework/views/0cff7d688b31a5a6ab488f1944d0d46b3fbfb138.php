...
<div class="row justify-content-end">
    <div class="col-auto">
        ...
        <div class="btn btn-sm btn-primary btn-icon m-1 float-end">
            <a href="#ticket-info" class="" type="button" data-bs-toggle="collapse" data-bs-placement="top" title="<?php echo e(__('Edit Ticket')); ?>"><i class="ti ti-edit text-white"></i></a>
        </div>
        <?php endif; ?>
    </div>
</div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-select <?php echo e(!empty($errors->first('category')) ? 'is-invalid' : ''); ?>" name="category" required="">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-select <?php echo e(!empty($errors->first('status')) ? 'is-invalid' : ''); ?>" name="status" required="">
                ...
                <div class="text-end">
                    ...
                    <a class="btn btn-secondary btn-light mr-2" href="<?php echo e(route('admin.tickets.index')); ?>"><?php echo e(__('Cancel')); ?></a>
                    ...
                    <div class="col">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">O.D.</th>
                                    <td><?php echo e($ticket->esfera_der); ?></td>
                                    <td><?php echo e($ticket->cilindro_der); ?></td>
                                    <td><?php echo e($ticket->eje_der); ?></td>
                                    <td><?php echo e($ticket->adicion_der); ?></td>
                                    <td><?php echo e($ticket->dnp_der); ?></td>
                                    <td><?php echo e($ticket->altura_der); ?></td>
                                </tr>
                                <tr>
                                    <th scope="row">O.I.</th>
                                    <td><?php echo e($ticket->esfera_izq); ?></td>
                                    <td><?php echo e($ticket->cilindro_izq); ?></td>
                                    <td><?php echo e($ticket->eje_izq); ?></td>
                                    <td><?php echo e($ticket->adicion_izq); ?></td>
                                    <td><?php echo e($ticket->dnp_izq); ?></td>
                                    <td><?php echo e($ticket->altura_izq); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col text-center p-3">
                            ...
                            <table class="table table-bordered table-striped mt-2">
                                ...
                                <tbody>
                                    <tr> 
                                        <td><?php echo e($ticket->horizontal); ?></td>
                                        <td><?php echo e($ticket->puente); ?></td>
                                        <td><?php echo e($ticket->vertical); ?></td>
                                        <td><?php echo e($ticket->diagonal); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <table class="table table-bordered table-striped mt-2">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">Biselado</th>
                                        <th scope="col">Tipo de Armazón</th>
                                ...
                                <tbody>
                                    <tr> 
                                        <td><?php echo e($ticket->tipo_lente); ?></td>
                                        <td><?php echo e($ticket->biselado); ?></td>
                                        <td><?php echo e($ticket->tipo_armazon); ?></td>
                                        <td><?php echo e($ticket->material); ?></td>
                                        <td><?php echo e($ticket->tratamiento); ?></td>
                                        <td><?php echo e($ticket->tinte); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
